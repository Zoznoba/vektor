...
/**
 * Табличный вид тех же данных, что и полосы CompetencyProfile выше по
 * странице — для чтения точных чисел по каждому слою разом, не только
 * self/others. Обязательный «табличный вид» результата поверх чарта:
