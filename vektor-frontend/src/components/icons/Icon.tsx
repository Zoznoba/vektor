...
const PATHS: Record<string, string[]> = {
  ...
  // Портфель: «кейс» в школьном нейминге — профильная группа, и портфель
  // читается мгновенно, в отличие от очередных человечков (users уже занят
  // разделом «Пользователи»).
  briefcase: ['M3 8h18v11H3z', 'M9 8V6h6v2', 'M3 13h18'],
